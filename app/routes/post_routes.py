...
def create_post():
    ...
    result, status_code = PostController.create_post(
        user_id=user_id,
...
def get_posts():
    ...
    result, status_code = PostController.get_posts(username, page, limit)
...
def get_feed():
    ...
    result, status_code = PostController.get_feed(user_id, page, limit)
...
def like_post(post_id):
    result, status_code = PostController.like_post(post_id)
